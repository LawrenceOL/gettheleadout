    ...
    <div className="topmargin ">
      <div className="page-template">
        <div topmargin="20px">
          <h1 className="title">
            {" "}
            <b>Add your pipes to our map </b>
          </h1>
        </div>
        <div>
          <h4>
            Add pictures of your water pipes to keep our system up to date.
          </h4>
        </div>
        <br />
        <div>
          <h3 textDecoration="bold">
            {" "}
            <b>Need help finding them?</b>
          </h3>
        ...
        <div>
          <h2 className="baby-title">
            Uploading pictures of your water pipes, will:
          </h2>
        </div>
        <div>
          ...
          <p>
            Your local government needs your help to know the amount of lead
            pipes in your area to apply for federal funds available for
        ...
        <div>
          <Form>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control
                type="zipcode"
                placeholder="*need icon here* Email Adress"
              />
            </Form.Group>
            ...
            {[
              ...
              "Allow local engineer to evaluate picture",
            ].map((type) => (

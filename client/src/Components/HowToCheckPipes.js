      ...
      <div className="page-template">
        ...
        <div>
          <h2 className="baby-title">
            {" "}
            1.) Follow our guided visual test below
          </h2>
          <h3>
            Sample text where description of guided visual test will be
            displayed.
          </h3>
        </div>
        <div>
        ...
        <div>
          ...
          <img
            alt="lead pipe"
            src={require("./Images/leadpipe.png").default}
            height={50}
            width={100}
          />
        ...
        <div>
          <h2 className="smaller-title">
            Add a photo, make a big impact in your community.
          </h2>
          <h3>
            By adding data, you help your community locate and remove lead
            pipes.
          </h3>
